...
namespace SlimUI.ModernMenu
{
    public class UIMenuManager : MonoBehaviour
    {
        ...
        [Header("LVL")] [Tooltip("IM SAD")] public LevelScriptableObject levelScriptableObject;
        ...
        public void LoadScene(string scene)
        {
            if (scene != "")
            {
                ...
                levelScriptableObject.currentLevel = 1;
        ...
        private void EnsureSingleEventSystem()
        {
            ...
            // Reactivate the menu EventSystem if it was deactivated
